...
namespace BoonAmber.Model
{
    ...
    public partial class ModelVersion : IEquatable<ModelVersion>, IValidatableObject
    {
        ...
        public ModelVersion(string release = default(string), string apiVersion = default(string), string builder = default(string), string expertApi = default(string), string expertCommon = default(string), string nanoSecure = default(string), string swaggerUi = default(string))
        {
            // to ensure "release" is required (not null)
            if (release == null)
            {
                throw new ArgumentNullException("release is a required property for ModelVersion and cannot be null");
            }
            this.Release = release;
            // to ensure "apiVersion" is required (not null)
            if (apiVersion == null)
            {
                throw new ArgumentNullException("apiVersion is a required property for ModelVersion and cannot be null");
            }
            this.ApiVersion = apiVersion;
            // to ensure "builder" is required (not null)
            if (builder == null)
            {
                throw new ArgumentNullException("builder is a required property for ModelVersion and cannot be null");
            }
            this.Builder = builder;
            // to ensure "expertApi" is required (not null)
            if (expertApi == null)
            {
                throw new ArgumentNullException("expertApi is a required property for ModelVersion and cannot be null");
            }
            this.ExpertApi = expertApi;
            // to ensure "expertCommon" is required (not null)
            if (expertCommon == null)
            {
                throw new ArgumentNullException("expertCommon is a required property for ModelVersion and cannot be null");
            }
            this.ExpertCommon = expertCommon;
            // to ensure "nanoSecure" is required (not null)
            if (nanoSecure == null)
            {
                throw new ArgumentNullException("nanoSecure is a required property for ModelVersion and cannot be null");
            }
            this.NanoSecure = nanoSecure;
            // to ensure "swaggerUi" is required (not null)
            if (swaggerUi == null)
            {
                throw new ArgumentNullException("swaggerUi is a required property for ModelVersion and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "api-version", IsRequired = true, EmitDefaultValue = false)]
        public string ApiVersion { get; set; }

        /// <summary>
        /// Gets or Sets Builder
        /// </summary>
        [DataMember(Name = "builder", IsRequired = true, EmitDefaultValue = false)]
        public string Builder { get; set; }

        /// <summary>
        /// Gets or Sets ExpertApi
        /// </summary>
        [DataMember(Name = "expert-api", IsRequired = true, EmitDefaultValue = false)]
        public string ExpertApi { get; set; }

        /// <summary>
        /// Gets or Sets ExpertCommon
        /// </summary>
        [DataMember(Name = "expert-common", IsRequired = true, EmitDefaultValue = false)]
        public string ExpertCommon { get; set; }

        /// <summary>
        /// Gets or Sets NanoSecure
        /// </summary>
        [DataMember(Name = "nano-secure", IsRequired = true, EmitDefaultValue = false)]
        public string NanoSecure { get; set; }

        /// <summary>
        /// Gets or Sets SwaggerUi
        /// </summary>
        [DataMember(Name = "swagger-ui", IsRequired = true, EmitDefaultValue = false)]
