...
namespace BoonAmber.Model
{
    ...
    /// </summary>
    [DataContract(Name = "postConfigRequest_allOf")]
    public partial class PostConfigRequestAllOf : IEquatable<PostConfigRequestAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostConfigRequestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostConfigRequestAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostConfigRequestAllOf" /> class.
        /// </summary>
        ...
        public PostConfigRequestAllOf(int featureCount = default(int), int streamingWindowSize = default(int), List<FeatureConfig> features = default(List<FeatureConfig>), int samplesToBuffer = default(int), float percentVariationOverride = -1.0F)
        {
        ...
        {
            return this.Equals(input as PostConfigRequestAllOf);
        }

        /// <summary>
        /// Returns true if PostConfigRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PostConfigRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostConfigRequestAllOf input)
        {
            if (input == null)
            {
                return false;
