...
namespace BoonAmber.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MRecentSamples :  IEquatable<MRecentSamples>
    {
        /// <summary>
        ...
        public MRecentSamples(int? versionNumber = default(int?), List<List<float?>> mValues = default(List<List<float?>>))
        {
            ...
            if (mValues == null)
            {
                throw new InvalidDataException("mValues is a required property for MRecentSamples and cannot be null");
            }
            else
            {
