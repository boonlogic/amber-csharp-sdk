...
namespace BoonAmber.Model
{
    ...
    /// GetPretrainResponse
    /// </summary>
    [DataContract(Name = "getPretrainResponse")]
    public partial class GetPretrainResponse : IEquatable<GetPretrainResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPretrainResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetPretrainResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPretrainResponse" /> class.
        /// </summary>
        ...
        public GetPretrainResponse(string state = default(string), string message = default(string))
        {
            ...
            if (state == null)
            {
                throw new ArgumentNullException("state is a required property for GetPretrainResponse and cannot be null");
            }
            this.State = state;
