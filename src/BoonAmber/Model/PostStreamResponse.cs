...
namespace BoonAmber.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PostStreamResponse : StreamStatus,  IEquatable<PostStreamResponse>
    {
        /// <summary>
