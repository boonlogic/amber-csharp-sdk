...
namespace BoonAmber.Model
{
        ...
        public partial class GetStatusResponse :  IEquatable<GetStatusResponse>
    {
        ...
        public GetStatusResponse(PCA pca = default(PCA), Uint64Array clusterGrowth = default(Uint64Array), Uint64Array clusterSizes = default(Uint64Array), Uint16Array anomalyIndexes = default(Uint16Array), Uint16Array frequencyIndexes = default(Uint16Array), Uint16Array distanceIndexes = default(Uint16Array), decimal? totalInferences = default(decimal?), decimal? numClusters = default(decimal?), int? anomalyThreshold = default(int?), string state = default(string))
        {
