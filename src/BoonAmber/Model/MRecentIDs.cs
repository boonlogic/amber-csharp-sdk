...
namespace BoonAmber.Model
{
    ...
    /// MRecentIDs
    /// </summary>
    [DataContract(Name = "m_RecentIDs")]
    public partial class MRecentIDs : IEquatable<MRecentIDs>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MRecentIDs" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MRecentIDs() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MRecentIDs" /> class.
        /// </summary>
        /// <param name="versionNumber">versionNumber.</param>
        /// <param name="mValues">mValues (required).</param>
        public MRecentIDs(int versionNumber = default(int), List<int> mValues = default(List<int>))
        {
            // to ensure "mValues" is required (not null)
            if (mValues == null)
            {
                throw new ArgumentNullException("mValues is a required property for MRecentIDs and cannot be null");
            }
        ...
        {
            return this.Equals(input as MRecentIDs);
        }

        /// <summary>
        /// Returns true if MRecentIDs instances are equal
        /// </summary>
        /// <param name="input">Instance of MRecentIDs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MRecentIDs input)
        {
            if (input == null)
            {
                return false;
