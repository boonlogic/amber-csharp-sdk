...
namespace BoonAmber.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EndpointUsageInfo :  IEquatable<EndpointUsageInfo>
    {
        /// <summary>
        ...
        public EndpointUsageInfo(decimal? callsTotal = default(decimal?), decimal? callsThisPeriod = default(decimal?), string lastCalled = default(string))
        {
