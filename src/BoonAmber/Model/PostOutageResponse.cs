...
namespace BoonAmber.Model
{
    ...
    public partial class PostOutageResponse : IEquatable<PostOutageResponse>, IValidatableObject
    {
        ...
        public PostOutageResponse(string state = default(string), string message = default(string), int progress = default(int), int clusterCount = default(int), int retryCount = default(int), int streamingWindowSize = default(int), int totalInferences = default(int))
        {
