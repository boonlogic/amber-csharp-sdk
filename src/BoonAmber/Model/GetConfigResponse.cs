...
namespace BoonAmber.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class GetConfigResponse : StreamingParameters,  IEquatable<GetConfigResponse>
    {
        /// <summary>
