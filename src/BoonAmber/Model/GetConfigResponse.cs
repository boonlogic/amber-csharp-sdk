...
namespace BoonAmber.Model
{
    ...
    /// GetConfigResponse
    /// </summary>
    [DataContract(Name = "getConfigResponse")]
    public partial class GetConfigResponse : IEquatable<GetConfigResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetConfigResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetConfigResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetConfigResponse" /> class.
        /// </summary>
        ...
        public GetConfigResponse(int anomalyHistoryWindow = default(int), int learningRateNumerator = default(int), int learningRateDenominator = default(int), int learningMaxClusters = default(int), int learningMaxSamples = default(int), int featureCount = default(int), int streamingWindowSize = default(int), List<FeatureConfig> features = default(List<FeatureConfig>), float percentVariation = default(float), int samplesToBuffer = default(int), float percentVariationOverride = default(float))
        {
            ...
            if (features == null)
            {
                throw new ArgumentNullException("features is a required property for GetConfigResponse and cannot be null");
            }
