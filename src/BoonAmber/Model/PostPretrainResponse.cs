...
namespace BoonAmber.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PostPretrainResponse :  IEquatable<PostPretrainResponse>
    {
        /// <summary>
        ...
        public PostPretrainResponse(string state = default(string), string amberTransaction = default(string), string amberChunk = default(string), string message = default(string))
        {
            ...
            if (state == null)
            {
                throw new InvalidDataException("state is a required property for PostPretrainResponse and cannot be null");
            }
            else
            {
                this.State = state;
