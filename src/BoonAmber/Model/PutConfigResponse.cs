...
namespace BoonAmber.Model
{
    ...
    /// PutConfigResponse
    /// </summary>
    [DataContract(Name = "putConfigResponse")]
    public partial class PutConfigResponse : IEquatable<PutConfigResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public PutConfigResponse(List<FusionConfig> features = default(List<FusionConfig>), LearningParameters streaming = default(LearningParameters))
        {
