...
namespace BoonAmber.Model
{
    ...
    /// </summary>
    [DataContract(Name = "postConfigResponse_allOf")]
    public partial class PostConfigResponseAllOf : IEquatable<PostConfigResponseAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostConfigResponseAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostConfigResponseAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostConfigResponseAllOf" /> class.
        /// </summary>
        ...
        public PostConfigResponseAllOf(int featureCount = default(int), int streamingWindowSize = default(int), List<FeatureConfig> features = default(List<FeatureConfig>), int samplesToBuffer = default(int), float percentVariationOverride = default(float))
        {
        ...
        {
            return this.Equals(input as PostConfigResponseAllOf);
        }

        /// <summary>
        /// Returns true if PostConfigResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PostConfigResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostConfigResponseAllOf input)
        {
            if (input == null)
            {
                return false;
