...
namespace BoonAmber.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PostConfigResponse : StreamingParameters,  IEquatable<PostConfigResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public PostConfigResponse(int? featureCount = default(int?), int? streamingWindowSize = default(int?), List<FeatureConfig> features = default(List<FeatureConfig>), int? samplesToBuffer = default(int?), float? percentVariationOverride = default(float?), int? anomalyHistoryWindow = default(int?), int? learningRateNumerator = default(int?), int? learningRateDenominator = default(int?), int? learningMaxClusters = default(int?), int? learningMaxSamples = default(int?)) : base()
        {
