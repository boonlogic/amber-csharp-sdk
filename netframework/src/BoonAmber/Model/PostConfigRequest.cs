...
namespace BoonAmber.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PostConfigRequest : StreamingParameters,  IEquatable<PostConfigRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public PostConfigRequest(int? featureCount = default(int?), int? streamingWindowSize = default(int?), List<FeatureConfig> features = default(List<FeatureConfig>), int? samplesToBuffer = default(int?), float? percentVariationOverride = -1.0f, int? anomalyHistoryWindow = default(int?), int? learningRateNumerator = default(int?), int? learningRateDenominator = default(int?), int? learningMaxClusters = default(int?), int? learningMaxSamples = default(int?)) : base()
        {
